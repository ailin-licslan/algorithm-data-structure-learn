...
public class Array<E> {
    ...
    public void addLast1(E e) {
        ...
        if (size == data.length) {
            throw new IllegalArgumentException("addLast element failed! Array is Full");
        }
    ...
    public void add(int index, E e) {
        ...
        if (index < 0 || index > size) {
            throw new IllegalArgumentException("add element failed! Array is required index>=0 and index<=size");
        }
    ...
    public E get(int index) {
        if (index < 0 || index >= size) {
            throw new IllegalArgumentException("get failed! Array is required index>=0 and index<=size");
        }
        return data[index];
    }
    ...
    public void set(int index, E e) {
        if (index < 0 || index >= size) {
            throw new IllegalArgumentException("set failed! Array is required index>=0 and index<=size");
        }
        data[index] = e;
    }
    ...
    public E remove(int index) {
        //index必须大于零 或者在之前数组实际大小的范围之内选择插入元素 不能选择大于size范围去操作
        if (index < 0 || index >= size) {
            throw new IllegalArgumentException("remove element failed! Array is required index>=0 and index<=size");
        }
        E ret = data[index];
